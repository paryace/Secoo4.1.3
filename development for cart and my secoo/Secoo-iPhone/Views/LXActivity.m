...
#define SHAREBUTTON_WIDTH                       50+10
#define SHAREBUTTON_HEIGHT                      50+10
#define SHAREBUTTON_INTERVAL_WIDTH              42.5-7.5
#define SHAREBUTTON_INTERVAL_HEIGHT             35

#define SHARETITLE_WIDTH                        50+10
#define SHARETITLE_HEIGHT                       20
#define SHARETITLE_INTERVAL_WIDTH               42.5-7.5
...
#define TITLE_INTERVAL_HEIGHT                   15-5
#define TITLE_HEIGHT                            45-20
...
#define BUTTON_INTERVAL_HEIGHT                  20+15
...
//    self.backGroundView.backgroundColor = ACTIONSHEET_BACKGROUNDCOLOR;
    self.backGroundView.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.9];
    UILabel *lineLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 1.0f)];
    lineLabel.backgroundColor = [UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:1];
    ...
    if (shareButtonTitlesArray) {
        if (shareButtonTitlesArray.count > 0 && shareButtonImagesNameArray.count > 0) {
            for (int j = 1; j < shareButtonTitlesArray.count+1; j++) {
                ...
                //有Title的时候
                if (self.isHadTitle == YES) {
                    [shareLabel setFrame:CGRectMake(SHARETITLE_INTERVAL_WIDTH+((line-1)*(SHARETITLE_INTERVAL_WIDTH+SHARETITLE_WIDTH)), self.LXActivityHeight+SHAREBUTTON_HEIGHT+((column-1)*(SHARETITLE_INTERVAL_HEIGHT)+5), SHARETITLE_WIDTH, SHARETITLE_HEIGHT)];
                }
...
//    cancelButton.layer.borderColor = [UIColor clearColor].CGColor;
    ...
    [cancelButton setTitleColor:[UIColor colorWithRed:240/255.0 green:90/255.0 blue:0 alpha:1] forState:UIControlStateNormal];
...
//    shareLabel.textColor = [UIColor whiteColor];
    shareLabel.textColor = [UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:1];
    return shareLabel;
}
