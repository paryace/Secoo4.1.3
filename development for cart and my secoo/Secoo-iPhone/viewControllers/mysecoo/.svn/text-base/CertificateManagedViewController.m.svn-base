//
//  CertificateManagedViewController.m
//  Secoo-iPhone
//
...
@interface CertificateManagedViewController ()
@property (weak, nonatomic) IBOutlet UITextField *nameTextField;

@end

@implementation CertificateManagedViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:@"CertificateManaged"];
}
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    [MobClick endLogPageView:@"CertificateManaged"];
}
